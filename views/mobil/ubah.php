						...
						<div class="card shadow">
							...
							<div class="card-body">
								<form method="POST" action="<?= base_url('mobil/proses_ubah/' . $mobil->id_mobil) ?>" enctype="multipart/form-data">
									...
									<div class="row">
										<div class="form-group col-6">
												<label for="tahun_beli">Jadwal Maintenance</label>
												<input type="date" value="<?= $mobil->maintenance ?>" name="maintenance" id="maintenance" required="required" autocomplete="off" class="form-control">
										</div>
										<div class="form-group col-6">
												<label for="tahun_beli">Jadwal Pembayaran Pajak Tahunan</label>
												<input type="date" value="<?= $mobil->pajak ?>" name="pajak" id="pajak" required="required" autocomplete="off" class="form-control">
										</div>
									</div>
										<div class="form-group">
											...
											<?php while($status = $data_status->fetch_object()) : ?>
													<option value="<?= $status->id_status ?>" <?= $mobil->id_status == $status->id_status ? 'selected' : '' ?>><?= $status->status ?></option>
												<?php endwhile; ?>
											</select>
										</div>
